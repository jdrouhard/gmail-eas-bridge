 ...
 */
    ...
    define('TIMEZONE', getenv('TZ') ?: 'UTC'); // patched for this stack: honor the container's TZ env var
    ...
    define('USE_CUSTOM_REMOTE_IP_HEADER', 'HTTP_X_FORWARDED_FOR'); // patched: trust the reverse proxy's forwarded-for header
 ...
 */
    ...
    define('STATE_DIR', '/data/zpush-state/'); // patched: lives under the shared /data mount, see docker-compose.yml
 ...
 */
    // Device Provisioning
    define('PROVISIONING', false); // patched: single trusted device, skip EAS policy enforcement
 ...
 */
    ...
    define('BACKEND_PROVIDER', 'BackendIMAP'); // patched: this stack always uses the IMAP backend
